...
import { BookMarked, BookOpen, PlusCircle, Search, Tag, UserCircle, XCircle } from 'lucide-react';
...
export function StepAddCourses({ selectedCourses, onUpdateCourses }: StepAddCoursesProps) {
   ...
   const filteredSearchResults = searchCourseResults?.courses.filter(
   ...
   return (
      <div className="space-y-6">
         <CardHeader className="p-0 mb-2">
            ...
            <CardDescription>
               스터디와 관련된 수업을 과목명, 과목코드, 교수명으로 검색하여 최대 {MAX_COURSES}개까지 추가하세요.
            </CardDescription>
         </CardHeader>
               ...
               <ul className="space-y-2 p-2">
                  {filteredSearchResults.map((course) => (
                     ...
                     >
                        ...
                        <Button size="sm" variant="outline" disabled={selectedCourses.length >= MAX_COURSES}>
