        ...
        <div className="container mx-auto py-6 px-4 max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mb-4">
                <div className="flex items-center gap-4">
                    <Button variant="outline" size="sm" onClick={() => navigate(-1)} className="flex items-center gap-1.5 px-2.5">
                ...
                {role === "MEMBER" && (
                    <div className="flex gap-2">
                        ...
                        <Button variant="destructive" size="sm" onClick={handleDelete} className="flex items-center gap-1.5 px-2.5">
                ...
                <Card className="py-0">
                    ...
                    <CardContent className="p-4 pt-0 ">
                        <div className="prose prose-sm max-w-none rounded-md min-h-[200px] border px-4 py-3">
                            <div dangerouslySetInnerHTML={{ __html: report?.content || "" }} className="prose dark:prose-invert" />
                        </div>
                    </CardContent>
                </Card>
