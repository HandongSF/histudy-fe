            ...
            <>
               <TabsContent value="all" className="space-y-4">
                  <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                     <ActivityCard title="총 스터디 원" value={activity.studyMembers} icon={Users} description="명" />
                     <ActivityCard
                        title="총 스터디 수"
                        ...
                        description="개"
                     />
                     <ActivityCard title="총 스터디 시간" value={activity.studyHours} icon={Clock} description="시간" />
                     <ActivityCard title="총 보고서 갯수" value={activity.reports} icon={FileText} description="개" />
                  </div>
               </TabsContent>
