               ...
               <Table>
                  <TableHeader>
                     <TableRow>
                        ...
                        <TableHead className="w-[180px]">그룹 누적 스터디 시간</TableHead>
                        <TableHead className="w-[150px] text-center">보고서 열람</TableHead>
                     </TableRow>
                  </TableHeader>
                  <TableBody>
                        ...
                        filteredActivities.map((activity) => (
                           <TableRow key={activity.tag}>
                              ...
                              <TableCell className="text-center">
                                 ...
                                 <Link to={paths.admin.manageReport} state={activity.group}>
