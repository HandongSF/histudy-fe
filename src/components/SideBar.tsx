...
import { BookOpen, Calendar, FileText, LifeBuoy, ListCheck, LogOut, Pen, UserCheck, UserCog, UserPlus, Users, UsersRound, type LucideIcon } from "lucide-react";
...
function RoleSwitcher() {
    ...
    return (
        <div className="p-3 group-data-[collapsible=icon]:p-2">
            <Select value={role} onValueChange={(newRole) => setRole(newRole as Role)}>
